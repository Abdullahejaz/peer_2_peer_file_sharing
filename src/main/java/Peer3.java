...
public class Peer3 extends Thread {
    ...
    public static String DIRECTORY_PEER3 = "peer3";
...
//Helps in registering Peer
    public void registration() throws Exception{
        ...
        //Adding all files in that are with peer3
        listOfFiles.add("1_p3.txt");
        listOfFiles.add("2_p3.txt");
        listOfFiles.add("3_p3.txt");
        listOfFiles.add("4_p3.txt");
        listOfFiles.add("5_p3.txt");
        listOfFiles.add("6_p3.txt");
        listOfFiles.add("7_p3.txt");
        listOfFiles.add("8_p3.txt");
        listOfFiles.add("9_p3.txt");
        listOfFiles.add("10_p3.txt");
        ...
        System.out.println("Server is registering PEER 3");
        System.out.println("                             ");
        ObjectOutputStream oos = new ObjectOutputStream(s.getOutputStream());

        //Has all the details of the peer object
        ModelPeer peer3 = new ModelPeer(InetAddress.getLocalHost().getHostName(), "7777", listOfFiles, "");
        message.setModel(peer3);
        ...
        System.out.println("---------------------------------------------------------------------------");
        System.out.println("Server successfully registered PEER 3 at " + message.getModel().getId());
        System.out.println("---------------------------------------------------------------------------");
        System.out.println("                                                                                           ");
        Thread.sleep(500);
    ...
    private String absoluteFilePath(String fileName, String location){
        ...
        File file = new File(Peer3.class.getProtectionDomain().getCodeSource().getLocation().getPath());

        //Getting the parent directory of file path
        File file1 = new File(file.getParent().concat("\\")+DIRECTORY_PEER3.concat("\\") + location);

        //getting list
        File[] fileList = file1.listFiles();
        String path = file.getParent().concat("\\")+DIRECTORY_PEER3.concat("\\") + location;

        if("receive".equalsIgnoreCase(location)){
            path = file.getParent().concat("\\")+DIRECTORY_PEER3.concat("\\") + location;
            return path;
        }
...
//searching for a file requested by peer
    ...
    public void run() {
        ...
        try
        {
            ...
            while(true){
                System.out.println("                                  ");
                System.out.println("**********************************************************");
                System.out.println("PEER 3 started at port 7777");
                System.out.println("**********************************************************");
                Socket newPeerSocket = ss.accept();
                new Peer3(newPeerSocket).start();
    ...
    public static void main(String args[]) throws Exception
    {
        ...
        while(true){
            ...
            System.out.println("   ");
            System.out.println("Enter 1 to REGISTER peer 3");
            ...
            switch (userInput){
                ...
                case "2":
                    ...
                    System.out.println("                 ");
                    System.out.println("Peer 3 need a file named " + fileName + " and wants to download it.");
                    peer3 = new Peer3();
                    peer3.searching(fileName);
                    break;
                ...
                case "3" :
                    ...
                    System.out.println("                 ");
                    System.out.println("Peer 3 requested for file " + fileToSearch);
                    for (int i =0; i< 1000; i++){
                        peer3 = new Peer3();
                        peer3.searching(fileToSearch);
                    }
